...
class _BluetoothScreenState extends State<BluetoothScreen> {
  ...
  //     // If the scan result finds a device with the name "My Device", then connect to it.
  //     device.add(scanResult.device);
  ...
  // //   flutterBlue.connect(device).listen((connection) {
  // //     this.connection = connection;
  // //     connection.onDataReceived.listen((data) {
  // //       // The data received will be the userID.
  // //       userID = data;
  // //       setState(() {});
  // //     });
  // //   });
  ...
  // void receiveString() async {
  //   bt.FlutterBlue flutterBlue = bt.FlutterBlue.instance;
  //   List<bt.BluetoothDevice> device = await flutterBlue.connectedDevices;
  //   device.first.state.listen((event) {
  //     event == bt.BluetoothDeviceState.connected ?
  //   });
  // }
  ...
  // return Scaffold(
  //   appBar: AppBar(
  //     title: const Text('Bluetooth UserID'),
  //   ),
  //   body: Column(
  //     children: [
  ...
  //       //               print(result.length);
  //       //             }
  //       //             BluetoothDevice r = result[index].device;
